...
For artifact-specific examples, read [templates.md](references/templates.md). Choose the template matching a PR description, review comment, or issue; do not impose all sections on a short reply.
